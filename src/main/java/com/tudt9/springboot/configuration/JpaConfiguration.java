package com.tudt9.springboot.configuration;
...
@Configuration
@EnableJpaRepositories(basePackages = "com.tudt9.springboot.repositories",
...
public class JpaConfiguration {
	...
	public LocalContainerEntityManagerFactoryBean entityManagerFactory() throws NamingException {
		...
		factoryBean.setPackagesToScan(new String[] { "com.tudt9.springboot.model" });
